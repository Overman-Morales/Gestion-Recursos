...
@RestController
    ...
    // Para paginar en el BackEnd
    @GetMapping("/paginados")
    public Page<DatosPersonales> listarDatosPersonalesPaginados(@RequestParam(defaultValue = "0") int page) {
        int size = 5; // Establece el tamaño de página en 5 registros
        Pageable pageable = PageRequest.of(page, size);
        return datosPersonalesService.getAllDatosPersonales(pageable);
    }
